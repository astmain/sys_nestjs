...
export class demo extends AppController {
  ...
  async find_list_demo(@Body() body: dto.find_list_demo) {
    ...
    const data = await this.db.tb_demo.findMany({ where: { name: body.name } })
    console.log('find_list_demo---data:', data)
    return { code: 200, msg: '成功:查询-数据-列表', result: data }
  }
  ...
  async init_demo(@Query('password', ParseIntPipe) password: number) {
    ...
    await this.db.tb_demo.create({ data: { name: 'test', remark: 'test', price_personal: 1, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test2', remark: 'test2', price_personal: 2, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test3', remark: 'test3', price_personal: 3, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test4', remark: 'test4', price_personal: 4, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test5', remark: 'test5', price_personal: 5, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test6', remark: 'test6', price_personal: 6, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test7', remark: 'test7', price_personal: 7, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test8', remark: 'test8', price_personal: 8, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test9', remark: 'test9', price_personal: 9, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test10', remark: 'test10', price_personal: 10, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test11', remark: 'test11', price_personal: 11, price_company: 0, price_extend: 0, list_img } })
    await this.db.tb_demo.create({ data: { name: 'test12', remark: 'test12', price_personal: 12, price_company: 0, price_extend: 0, list_img } })
